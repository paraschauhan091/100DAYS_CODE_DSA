...
// Generate commits from 2026-03-22 to 2026-04-29
const startDate = moment('2026-03-22');
...
while (currentDate.isSameOrBefore(endDate, 'day')) {
    // Random number of commits per day (1 to 10)
    const commitsToday = getRandomInt(1, 10);
